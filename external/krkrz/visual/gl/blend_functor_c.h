...
/**
 * alpha_blend_functor;			//
 * alpha_blend_HDA_functor;		// 
 * alpha_blend_o_functor;		//
 * alpha_blend_HDA_o_functor;	//
 *
 * alpha_blend_d_functor;		//
 * alpha_blend_do_functor;		//
 *
 * alpha_blend_a_functor;		//
 * alpha_blend_ao_functor;		//
 */
//------------------------------------------------------------------------------
/** アルファブレンド */
