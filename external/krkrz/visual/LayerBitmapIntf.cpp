		...
		{                                                                     \
			while(h--)                                                        \
				basename##_HDA != 0 ? \
					...
					(void)TVPAddLog("(notimp) " #basename "_HDA not implemented"), \
				dest+=dpitch, src+=spitch;                                    \
		}                                                                     \
	}                                                                         \
	else                                                                      \
		...
		{                                                                     \
			while(h--)                                                        \
				basename##_o != 0 ? \
					...
					(void)TVPAddLog("(notimp) " #basename "_o not implemented"), \
				dest+=dpitch, src+=spitch;                                    \
		}                                                                     \
		else                                                                  \
		{                                                                     \
			while(h--)                                                        \
				basename##_HDA_o != 0 ? \
					...
					(void)TVPAddLog("(notimp) " #basename "_HDA_o not implemented"), \
				dest+=dpitch, src+=spitch;                                    \
		}                                                                     \
	}
