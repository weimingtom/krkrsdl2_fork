...
const tjs_char* TVPKAGNoLine = TJS_W("TVPKAGNoLine %1 empty");
const tjs_char* TVPKAGCannotOmmitFirstLabelName = TJS_W("TVPKAGCannotOmmitFirstLabelName");
#if 0
const tjs_char* TVPInternalError = TJS_W("TVPInternalError: at %1 line %2");
#endif
const tjs_char* TVPKAGMalformedSaveData = TJS_W("TVPKAGMalformedSaveData");
const tjs_char* TVPKAGLabelNotFound = TJS_W("TVPKAGLabelNotFound %1  %2 ");
const tjs_char* TVPLabelOrScriptInMacro = TJS_W("TVPLabelOrScriptInMacro iscript ");
const tjs_char* TVPKAGInlineScriptNotEnd = TJS_W("[endscript] @endscript TVPKAGInlineScriptNotEnd");
const tjs_char* TVPKAGSyntaxError = TJS_W("TVPKAGSyntaxError '[' '] \" \" macro endmacro ");
const tjs_char* TVPKAGCallStackUnderflow = TJS_W("return call return TVPKAGCallStackUnderflow)");
const tjs_char* TVPKAGReturnLostSync = TJS_W("TVPKAGReturnLostSync return ");
const tjs_char* TVPKAGSpecifyKAGParser = TJS_W("KAGParser TVPKAGSpecifyKAGParser");
const tjs_char* TVPUnknownMacroName = TJS_W("TVPUnknownMacroName \"%1\"");
