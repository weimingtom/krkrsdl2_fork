...
typedef void (*tTVPGraphicLoadingHandlerForPlugin)(void* formatdata,
	...
	tjs_int32 keyidx,
	tTVPGraphicLoadMode mode);
typedef void (*tTVPGraphicHeaderLoadingHandlerForPlugin)(void* formatdata, IStream_* src, class iTJSDispatch2** dic );
typedef void (*tTVPGraphicSaveHandlerForPlugin)(void* formatdata, void* callbackdata, IStream_* dst, const ttstr & mode,
